...
namespace XPokerEvalConsole
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //eval_5_card_hands(deck);
            eval_3_card_hands(deck);

            Console.ReadLine();
        }

        private static void eval_5_card_hands(int[] deck)
        {
            int a, b, c, d, e, j;
            ushort i;
            int[] hand = new int[5];
        ...
        private static void eval_3_card_hands(int[] deck)
        {
            int[] hand = new int[3];
            int[] freq = new int[10];
            ushort i;
            ...
            for (int a = 0; a < 50; a++)
            {
                ...
                for (int b = a + 1; b < 51; b++)
                {
                    ...
                    {
                        hand[2] = deck[c];
                        i = PokerCalculator.PokerLib.eval_3cards_fast(hand);
                        j = PokerCalculator.PokerLib.hand_rank(i);
                        freq[j]++;
                    }
                }
            ...
            Console.WriteLine("3 CARD EVALUATION");
            Console.WriteLine("No Pair:           {0:N0}", freq[9]);
            Console.WriteLine("One Pair:          {0:N0}", freq[8]);
            Console.WriteLine("Two Pair:          {0:N0}", freq[7]);
            Console.WriteLine("Three of a Kind:   {0:N0}", freq[6]);
            ...
            Console.WriteLine("Enumerated and evaluated {0:N0} hands", totalHands);
        }
