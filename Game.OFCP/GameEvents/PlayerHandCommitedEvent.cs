...
namespace Game.OFCP.GameEvents
{
    public class PlayerHandCommitedEvent : Event
    {
        ...
        public PlayerHandCommitedEvent(string tableId, string gameId, string playerId, string[] bottom, string[] middle, string[] top)
        {
