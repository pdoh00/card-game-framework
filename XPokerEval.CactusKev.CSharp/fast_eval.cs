...
namespace PokerCalculator
{
    public static partial class PokerLib
    {
        ...
        public static bool IsSequential(IEnumerable<int> values)
        {
        ...
        private static int parsedRank(string card)
        {
            int cardrank;

            if (!int.TryParse(card, out cardrank))
            {
                switch (card.ToUpper())
                {
                    case "J":
        ...
        public static ushort eval_5hand_fast(int[] hand)
        {
            int c1, c2, c3, c4, c5;
